 ...
 */
angular.module('fantasyDraftUiApp').controller('TransferWindowCtrl', 

	function ($scope, $http, $rootScope, $modal) {

		// $http.get('http://localhost:8080/fantasy-draft-api/fantasydraft/user/authenticate/retrieve/userdetails');
		...
		$http.get('http://localhost:8080/fantasy-draft-api/fantasydraft/team').success(function (data) {
			...
			$http.get('http://localhost:8080/fantasy-draft-api/fantasydraft/auction/team/status').success(function(data) {
		...
		$rootScope.postTeamSelection = function () {
			...
			$http.post('http://localhost:8080/fantasy-draft-api/fantasydraft/auction/bid', bidsRequest).success(function(data) {
